...
var __dirname = null;
var Module =
	typeof VorbisDecoderModule !== "undefined" ? VorbisDecoderModule : {};
var moduleOverrides = {};
var key;
for (key in Module) {
...
var _stb_vorbis_close = (Module["_stb_vorbis_close"] = function () {
	return (_stb_vorbis_close = Module["_stb_vorbis_close"] =
...
var _stb_vorbis_decode_frame_pushdata = (Module[
...
var _stb_vorbis_open_pushdata = (Module["_stb_vorbis_open_pushdata"] =
	function () {
		return (_stb_vorbis_open_pushdata = Module[
...
if (typeof WorkerGlobalScope === "function") {
	class VorbisWorkerDecoder {
		...
		open(arrayBuffer) {
			...
			this.makeBuffer();
			this.v = Module._stb_vorbis_open_pushdata(
				this.bufferPtr,
				this.bufferSize,
				this.usedPtr,
				null,
		...
		decodeFrame() {
			this.makeBuffer();
			const used = Module._stb_vorbis_decode_frame_pushdata(
				this.v,
				this.bufferPtr,
				this.bufferSize,
				null,
		...
		concatenate() {
			for (let i = 0; i < this.channels; i++) {
				this.data[i] = new Float32Array(
					this.totalSamples * this.sampleScale
				);
				let offset = 0;
		...
		sendBack() {
			if (this.totalSamples > 0) {
				...
				const message = {
					id: this.id,
					sampleRate: this.sampleRate * this.sampleScale,
					data: this.data,
				};
				const transfer = [];
				for (let i = 0; i < this.channels; i++) {
