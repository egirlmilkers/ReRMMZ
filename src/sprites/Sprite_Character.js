...
Sprite_Character.prototype.tilesetBitmap = function (tileId) {
	const tileset = DataManager.$gameMap.tileset();
...
Sprite_Character.prototype.updateBitmap = function () {
	if (this.isImageChanged()) {
		this._tilesetId = DataManager.$gameMap.tilesetId();
...
Sprite_Character.prototype.isImageChanged = function () {
	return this._tilesetId !== DataManager.$gameMap.tilesetId() || this._tileId !== this._character.tileId() || this._characterName !== this._character.characterName() || this._characterIndex !== this._character.characterIndex();
};
...
Sprite_Character.prototype.patternWidth = function () {
	if (this._tileId > 0) {
		return DataManager.$gameMap.tileWidth();
...
Sprite_Character.prototype.patternHeight = function () {
	if (this._tileId > 0) {
		return DataManager.$gameMap.tileHeight();
	} else if (this._isBigCharacter) {
