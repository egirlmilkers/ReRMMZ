...
Window_ShopStatus.prototype.drawPossession = function (x, y) {
	...
	this.resetTextColor();
	this.drawText(DataManager.$gameParty.numItems(this._item), x, y, width, "right");
};
...
Window_ShopStatus.prototype.statusMembers = function () {
	...
	return DataManager.$gameParty.members().slice(start, end);
};
...
Window_ShopStatus.prototype.maxPages = function () {
	return Math.floor((DataManager.$gameParty.size() + this.pageSize() - 1) / this.pageSize());
};
