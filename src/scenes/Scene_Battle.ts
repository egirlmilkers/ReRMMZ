...
import { Sprite_Button, Spriteset_Battle } from "../sprites/index.js";
import {
	Window_ActorCommand,
	Window_BattleActor,
	Window_BattleEnemy,
...
export class Scene_Battle extends Scene_Message {
	...
	update() {
		...
		DataManager.$gameTimer.update(active);
	...
	terminate() {
		super.terminate();
		DataManager.$gameParty.onBattleEnd();
		DataManager.$gameTroop.onBattleEnd();
		AudioManager.stopMe();
	...
	onItemOk() {
		...
		DataManager.$gameParty.setLastItem(item);
		this.onSelectAction();
	}
